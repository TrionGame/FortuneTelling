    ...
    $("#calcBtn").click(function () {
        ...
        if (errMsg.length > 0) {
            ...
            */
            ...
            //修正後
            $("#valPinnacle_1_ans").html(numToCircleNum[result.sumBdate2.cntSum] + "<span class='res-contents br-sp' style='font-weight: 500;margin-left: 10px;vertical-align: text-bottom;display: inline-block;'>" + numKeyWord[result.sumBdate.cntSum] + "</span>");
